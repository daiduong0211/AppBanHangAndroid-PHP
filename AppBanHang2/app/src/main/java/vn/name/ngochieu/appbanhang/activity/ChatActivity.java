...
import vn.name.ngochieu.appbanhang.adapter.ChatAdapter;
import vn.name.ngochieu.appbanhang.model.ChatMessage;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void insertUser() {
        ...
        //fix id user để mỗi user khi chat với admin có 1 id riêng
    ...
    private void sendMessToFire() {
        ...
        if (TextUtils.isEmpty(str_mess)){
            ...
            message.put(Utils.RECEIVEDID,Utils.ID_RECEIVED); //id_received lấy từ hàm main lúc đăng nhập

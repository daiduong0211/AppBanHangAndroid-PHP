...
import vn.name.ngochieu.appbanhang.Interface.IImageClickListener;
...
public class GioHangAdapter extends RecyclerView.Adapter<GioHangAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull GioHangAdapter.MyViewHolder holder, int position) {
        ...
        if (gioHang.getHinhsp().contains("http")){
            ...
            String hinhanh= Utils.BASE_URL+"image/"+gioHang.getHinhsp();
            ...
            public void onImageClick(View view, int pos, int giatri) {
                if (giatri == 1 ){
                    if(gioHangList.get(pos).getSoluong()>1) {
                        ...
                        builder.setMessage("Bạn có muốn xoá sản phẩm này khỏi gian hàng ");
